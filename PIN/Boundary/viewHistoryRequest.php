...
<body>
  <div class="page-wrap">
    <header class="header-inline" role="banner" aria-label="Page header">
      ...
      <div class="page-title" role="heading" aria-level="1">Request History</div>
        ...
        <table class="data-table" role="table">
          ...
          <tbody>
            <?php if (empty($completedRequests)): ?>
              <tr><td colspan="4" class="no-data">No completed requests found for the selected filters.</td></tr>
            <?php else: ?>
