...
require_once __DIR__ . '/../Controller/SearchHistoryRequestCon.php';

$pinID = $_SESSION['userID'];
$controller = new SearchHistoryRequestCon($conn);
...
<body>
  <div class="page-wrap">
    <header class="header-inline" role="banner" aria-label="Page header">
      ...
      <div class="page-title" role="heading" aria-level="1">Search Request History</div>
    </header>
