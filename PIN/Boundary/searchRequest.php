...
$controller = new SearchRequestCon($conn);
...
<body>
  <div class="page-wrap">
    ...
    <main class="card" role="main" aria-labelledby="search-request-heading">
      <h2 id="search-request-heading" class="page-heading">Search Criteria</h2>
