...
// pull info of pin's requests to make the dropdown box for search
$allRequests = $controller->getAllRequests($pinID);

// makes the categories to put into the dropdown box
$categories = [];
...
<table>
    ...
    <?php foreach ($results as $r): ?>
        <tr>
            ...
            <td><?= htmlspecialchars(date('Y-m-d')) ?></td>
