...
For windows user,
  ...
  4. Open browser http://localhost/Zealous/landing.html
  5. First time load into login page will take longer for script to create tables and generate samples into the database
