<?php
require_once __DIR__ . '/../../Controller/UserStory2/UserAccountCon.php';

$controller = new UserAccountCon($conn);
...
<body>
    <?php if ($selectedUser): ?>
        <div class="container">
            ...
            <a href="viewUserAcc.php" class="back-link">Back</a>
        </div>
    <?php else: ?>
        <h2>User Accounts</h2>
        <table>
            ...
            <?php else: ?>
                <?php foreach ($users as $u): ?>
                    <tr>
                        ...
                        <td>
                            <a class="view-link" href="viewUserAcc.php?id=<?= urlencode($u['userID']) ?>">View Details</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
