<?php
require_once __DIR__ . '/../../Controller/UserProfile/ManageUserProfileCon.php';

$controller = new ManageUserProfileCon();
$message = "";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['toggle'])) {
        ...
        $message = $controller->deleteProfile($id);
    }
...
<html>
<head>
    <title>Delete / Suspend User Profiles</title>
    <style>
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST">
                            ...
                            <?php endif; ?>
                            <button type="submit" name="delete" class="delete" onclick="return confirm('Are you sure you want to delete this profile?');">Delete</button>
                        </form>
                    </td>
                </tr>
            <?php endforeach; ?>
